...
public class CrawlerGrade {
	 ...
	 * @throws IOException
	 */
	public String exportGradeExcel(String cookie, String account, String xnm, String xqm, String xm, String path)
			throws IOException {
		// 请求头，设置请求cookie
		...
		return "成绩爬取成功：" + filePath + "<br/><button onclick='javascript:history.back(1);' >返回</button>";
	}
