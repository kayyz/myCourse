...
public class CrawlerFreeClassroom {
	 ...
	 * @throws IOException
	 */
	public String exportFreeClassroomExcel(String cookie, String xnm, String xqm, String week, String xqj, String lesson, String path)
			throws IOException {
		// 请求头，设置请求cookie
		...
		return "空闲教室数据爬取成功，路径为：" + filePath + "<br/><button onclick='javascript:history.back(1);' >返回</button>";
	}
